...
void opcontrol() {
	...
	while (true)
	{
		...
		pros::lcd::print(6,"%d %d %d %d",RopoDevice::Downloader.data.width,RopoDevice::Downloader.data.height,RopoDevice::Downloader.data.midx,RopoDevice::Downloader.data.find_flag);
